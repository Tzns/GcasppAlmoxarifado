...
namespace Almoxarifado.Migrations
{
    ...
    [Migration("20210926165443_saidas")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Almoxarifado.Models.GSaida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Almoxarifado.Models.GSaidaItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Almoxarifado.Models.GEntrada", b =>
                {
                    b.HasOne("Almoxarifado.Models.GFornecedor", "GFornecedor")
                        .WithOne()
                        .HasForeignKey("Almoxarifado.Models.GEntrada", "GFornecedorId")
            ...
            modelBuilder.Entity("Almoxarifado.Models.GEntradaItem", b =>
                {
                    ...
                    b.HasOne("Almoxarifado.Models.GProduto", "GProduto")
                        .WithOne()
                        .HasForeignKey("Almoxarifado.Models.GEntradaItem", "GProdutoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Almoxarifado.Models.GSaidaItem", b =>
                {
                    b.HasOne("Almoxarifado.Models.GProduto", "GProduto")
                        .WithOne()
                        .HasForeignKey("Almoxarifado.Models.GSaidaItem", "GProdutoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Almoxarifado.Models.GSaida", "GSaida")
                        .WithMany("GSaidaItem")
                        .HasForeignKey("GSaidaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
